...
import { useTranslations } from 'next-intl'; // Подключаем хук локализации

function BookingContent() {
  const t = useTranslations("Booking"); // Инициализируем переводы
            ...
            <div className="-mt-20 flex flex-col justify-center bg-background px-6 py-12 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] lg:mt-0 lg:h-full lg:rounded-none lg:shadow-none lg:px-12 transition-all duration-500">
                ...
                {status === 'success' ? (
                   <div className="flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
                      ...
                      <h3 className="font-serif text-3xl font-bold uppercase text-white mb-2">{t("success.title")}</h3>
